...
from solution_release import public_paths as solution_paths
...
] + [PREFIX + "/" + name for name in WALKTHROUGH_IMAGES + WALKTHROUGH_REPORTS] + WORD_PATHS + solution_paths()
REPOSITORY_ONLY = [
    ...
    "tools/solution_release.py", "tools/test_solution_release.py",
    "tools/prepare_solution_release.py",
]
