...
ready = (qa.get("status") == "PASS" and qa.get("scope") == "MATCHED_CANVAS_WALKTHROUGH_LOCAL_SITE_QA"
         ...
         and privacy.get("status") == "PASS" and privacy.get("scope") == "MATCHED_CANVAS_WALKTHROUGH_PUBLIC_TREE"
...
m = {
    "schemaVersion": "4.0", "status": "READY_FOR_PARENT_PUBLICATION" if ready else "LOCAL_REVIEW_PENDING",
    "scope": "MATCHED_CANVAS_WALKTHROUGH_PUBLIC_DERIVATIVES_ONLY",
